"""
Energy-based model from here: https://github.com/yilundu/reduce_reuse_recycle/blob/main/composable_diffusion/unet.py
...
class UNetModel(nn.Module):
    ...
    def forward(self, x, timesteps, ):
        ...
        for module in self.output_blocks:
            ...
            h = module(h, emb)
        h = h.to(x.dtype)
        return self.out(h) / self.marginal_prob_std(timesteps)[:,None,None,None]




class ScaleModel(nn.Module):
    def __init__(self, time_embedding_dim, max_period, dim_out, init_scale):
        super().__init__()
        ...
        self.linear1 = nn.Linear(self.time_embedding_dim, 256)
        self.linear2 = nn.Linear(256, 256)
        self.linear3 = nn.Linear(256, self.dim_out)
